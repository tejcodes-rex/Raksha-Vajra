...
**Core AI Components:**
- **Amazon Bedrock**: Advanced reasoning for contextual fraud detection and psychological manipulation analysis
...
- Visual analysis via Amazon Bedrock Vision with memory cleanup
...
**Purpose**: Advanced AI reasoning for fraud detection using Amazon Bedrock
**Capabilities**:
